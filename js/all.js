...
$(document).ready(function(){
    ...
    $.getJSON('http://taoalpha.me/blog/api/latest.json',function(data){
      var template = '<div class="singleline"></div><div class="blogc"><div class="imgbox"><img src="images/blogicon.png" alt="blogicon"></div><div class="alltext"><a href="__B_LINK__" class="blogtitle">__B_TITLE__</a><h6 class="blogdate">__B_DATE__</h6><a href="__B_LINK__" class="blogsummary"><p>__B_SUMMARY__</p></a></div></div>'
